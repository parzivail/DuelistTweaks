...
public class BlockStateGenerator
{
	...
	{
		BlockStateVariantMap blockStateVariantMap = BlockStateVariantMap.create(ageProperty, bloomingProperty).register((integer, bool) -> BlockStateVariant.create().put(VariantSettings.MODEL, IdentifierUtil.concat(modelId, "_stage" + integer + (bool ? "_blooming" : ""))));
		return VariantsBlockStateSupplier.create(block).coordinate(blockStateVariantMap);
	}
